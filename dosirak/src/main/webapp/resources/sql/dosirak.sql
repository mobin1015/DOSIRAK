...
CREATE TABLE USER_T (
	...
	BLOG_IMG_PATH	VARCHAR2(100 BYTE)	DEFAULT '/upload/profile_default.png',
...
CREATE TABLE LIKE_T (
    ...
    CONSTRAINT FK_LIKE_BLOG_DETAIL FOREIGN KEY (BLOG_LIST_NO)
        REFERENCES BLOG_DETAIL_T (BLOG_LIST_NO) ON DELETE CASCADE
);
...
INSERT INTO USER_T VALUES(USER_SEQ.NEXTVAL, 'admin@example.com', STANDARD_HASH('admin', 'SHA256'), 'admin', '010-1111-1111', '0', 'man', CURRENT_DATE, CURRENT_DATE, NULL, '/upload/profile_default.png', 'admin');
--INSERT INTO BLOG_DETAIL_T VALUES(BLOG_LIST_SEQ.NEXTVAL, 1, '�׽�Ʈ', '�׽�Ʈ', CURRENT_DATE, CURRENT_DATE, 1, 'it', 1, 0); 
