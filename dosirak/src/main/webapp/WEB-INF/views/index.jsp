...
<jsp:include page="./layout/header.jsp" />
    ...
    <div class="section">
      ...
      <div class="keyword-wrap">
        <ul>
          <li><a href="javascript:fnKeywordList()" class="keyword-list" data-keyword-no="1" ><span>지구한바퀴<br/>세계여행</span></a></li>
          <li><a href="" data-keyword="2"><span>그림·웹툰</span></a></li>
          <li><a href="" data-keyword="3"><span>IT<br/>트렌드</span></a></li>
          <li><a href="" data-keyword="4"><span>사진·촬영</span></a></li>
          <li><a href="" data-keyword="5"><span>취향저격<br/>영화 리뷰</span></a></li>
          <li><a href="" data-keyword="6"><span>오늘은<br/>이런 책</span></a></li>
        </ul>
      </div>
    </div>
