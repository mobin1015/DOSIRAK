...
public class MySecurityUtils {
	...
	/*
	 * SHA-256 1. 어떤 값을 256비트(32바이트)로 암호화하는 해시 알고리즘이다. 2. 암호화는 가능하고 복호화는 불가능하다. (단방향
	 * 알고리즘) 3. java.security 패키지를 활용한다.
	 */
	...
	/*
	 * 크로스 사이트 스크립팅 (Cross Site Scripting) 1. 스크립트 코드를 입력하여 시스템을 공격할 수 있다. 2. 스크립트
	 * 코드에 반드시 필요한 "<script>" 입력을 무력화하기 위해서 "<" 기호와 ">" 기호를 엔티티 코드로 변환한다.
	 */
	...
	/*
	 * 인증코드 1. 랜덤으로 생성해야 한다. 2. 보안을 위해 SecureRandom 클래스를 활용한다.
	 */
